...
export function WhatsAppButton() {
  return (
    ...
    >
      <div className="absolute inset-0 rounded-full animate-ping bg-brand-whatsapp opacity-75"></div>
      <svg
      ...
      <span className="absolute right-[80px] rounded-md bg-gray-900 px-3 py-1.5 text-xs font-medium text-white shadow-md opacity-0 transition-opacity group-hover:opacity-100 hidden md:block whitespace-nowrap">
